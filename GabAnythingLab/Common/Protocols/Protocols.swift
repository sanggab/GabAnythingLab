...
//    
//    
//    func getReducer(content: Content, reducers: [any GabReducer]) -> some View {
//        return ForEach(zones, id: \.self) { zone in
//            
//        }
//    }
//    
//    @ViewBuilder
//    func test(content: Content, reducer: some GabReducer) -> some View {
//        content.environmentObject(reducer)
//    }
//}
